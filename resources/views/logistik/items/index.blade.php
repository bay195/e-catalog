...
<div class="py-5" style="background-color: #f0f2f5;"> 
    <div class="container">
        ...
        <div class="p-4 mb-5 bg-white shadow rounded border">
            <h2 class="mb-4">Daftar Item untuk Dilengkapi oleh Logistik</h2>
            ...
            <table class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($item->status == 3)
                                <a href="{{ route('logistik.items.edit', $item->id) }}" class="btn btn-sm btn-warning">Lengkapi Data</a>
                                <form action="{{ route('logistik.items.submit', $item->id) }}" method="POST" class="d-inline">
                                    @csrf @method('PUT')
                            ...
                            <form action="{{ route('logistik.items.destroy', $item->id) }}" method="POST" class="d-inline">
                                @csrf @method('DELETE')
                    ...
                    @empty
                    <tr>
                        <td colspan="6" class="text-center">Tidak ada item yang perlu dilengkapi oleh Logistik.</td>
                    </tr>
                    @endforelse
                </tbody>
                </table>
